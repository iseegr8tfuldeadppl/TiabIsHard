...
public final class RoundedTransformationBuilder {
  ...
  private RoundedTransformationBuilder cornerRadius(float radius) {
  ...
  private RoundedTransformationBuilder cornerRadius(@Corner int corner, float radius) {
